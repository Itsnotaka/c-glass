...
import { DEFAULT_GIT_TEXT_GENERATION_MODEL_BY_PROVIDER, PiModelOptions } from "./model";
...
const PiModelOptionsPatch = Schema.Struct({
  ...
  thinking: Schema.optionalKey(PiModelOptions.fields.thinking),
  effort: Schema.optionalKey(PiModelOptions.fields.effort),
  fastMode: Schema.optionalKey(PiModelOptions.fields.fastMode),
  contextWindow: Schema.optionalKey(PiModelOptions.fields.contextWindow),
});
