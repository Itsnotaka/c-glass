...
export function normalizePiModelOptionsWithCapabilities(
  ...
  const reasoningEffort = modelOptions?.reasoningEffort
    ...
    : undefined;
  const effortFromReasoning = reasoningEffort as PiModelOptions["reasoningEffort"];
  const effort = modelOptions?.effort ? resolveEffort(caps, modelOptions.effort) : undefined;
  const effortTyped = effort as PiModelOptions["effort"];
  ...
  const nextOptions: PiModelOptions = {
    ...(effortFromReasoning !== undefined ? { reasoningEffort: effortFromReasoning } : {}),
    ...(effortTyped !== undefined ? { effort: effortTyped } : {}),
