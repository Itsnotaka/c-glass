...
const PATH_CAPTURE_START = "__GLASS_PATH_START__";
const PATH_CAPTURE_END = "__GLASS_PATH_END__";
...
function envCaptureStart(name: string): string {
  return `__GLASS_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__GLASS_ENV_${name}_END__`;
}
