...
const getSlowRpcAckRequestsValue = (): ReadonlyArray<SlowRpcAckRequest> =>
  appAtomRegistry.get(slowRpcAckRequestsAtom);

const shouldTrackRpcAck = (tag: string) => !tag.startsWith("subscribe");

export const getSlowRpcAckRequests = (): ReadonlyArray<SlowRpcAckRequest> =>
...
export const useSlowRpcAckRequests = (): ReadonlyArray<SlowRpcAckRequest> =>
  useAtomValue(slowRpcAckRequestsAtom);
