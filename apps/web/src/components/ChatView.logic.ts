import { ProjectId, type ModelSelection, type ThreadId, type TurnId } from "@glass/contracts";
...
export const LAST_INVOKED_SCRIPT_BY_PROJECT_KEY = "glass:last-invoked-script-by-project";
const WORKTREE_BRANCH_PREFIX = "glass";
