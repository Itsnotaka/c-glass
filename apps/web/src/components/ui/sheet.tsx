...
import { IconX } from "central-icons";
...
/** @deprecated Use `SheetContent`; kept for sidebar mobile shell. */
...
function SheetDescription({ className, ...props }: SheetPrimitive.Description.Props) {
  return (
    <SheetPrimitive.Description
      ...
      className={cn("text-detail/relaxed text-muted-foreground", className)}
      {...props}
    />
  );
}
