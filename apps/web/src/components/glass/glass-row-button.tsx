...
const chromeRow =
  "font-glass glass-sidebar-label flex min-h-7.5 w-full items-center justify-start gap-2 rounded-lg border border-transparent px-2 py-1 text-left text-muted-foreground transition-colors hover:bg-glass-hover hover:text-foreground data-[selected=true]:border-glass-border/90 data-[selected=true]:bg-glass-active data-[selected=true]:text-foreground";

const agentRow =
  "font-glass flex min-h-7.5 w-full items-center justify-start gap-2 rounded-lg border border-transparent px-2 py-1 text-left text-[13px]/[18px] text-muted-foreground transition-colors hover:bg-glass-hover hover:text-foreground data-[selected=true]:border-glass-border/90 data-[selected=true]:bg-glass-active data-[selected=true]:text-foreground";
