      ...
      >
        <button
          ...
          className={cn(
            ...
            props.planActive && "glass-plan-mode-chip--on",
          )}
          onClick={() => props.onPlanMode()}
          aria-pressed={props.planActive ?? false}
          aria-label={props.planActive ? "Turn off plan mode" : "Turn on plan mode"}
          title={props.planActive ? "Plan mode on (⇧Tab)" : "Plan mode off (⇧Tab)"}
        >
