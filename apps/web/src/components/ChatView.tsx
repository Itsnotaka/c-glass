...
import { applyClaudePromptEffortPrefix, normalizeModelSlug } from "@glass/shared/model";
import { truncate } from "@glass/shared/String";
...
export default function ChatView({ threadId }: ChatViewProps) {
  ...
  const unlockedSelectedProvider = resolveSelectableProvider(
    providerStatuses,
    selectedProviderByThreadId ?? threadProvider ?? "pi",
  );
  ...
  const searchableModelOptions = useMemo(
    () =>
      AVAILABLE_PROVIDER_OPTIONS.filter(
        ...
        option.value === "pi"
          ? modelOptionsByProvider.pi.map(({ slug, name }) => ({
