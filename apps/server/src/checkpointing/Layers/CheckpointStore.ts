...
import { GitCommandError } from "@glass/contracts";
import { GitCore } from "../../git/Services/GitCore.ts";
import { CheckpointStore, type CheckpointStoreShape } from "../Services/CheckpointStore.ts";
import { CheckpointRef } from "@glass/contracts";
...
const makeCheckpointStore = Effect.gen(function* () {
  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = Effect.fn(
    ...
    yield* Effect.acquireUseRelease(
      fs.makeTempDirectory({ prefix: "glass-fs-checkpoint-" }),
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "Glass",
          GIT_AUTHOR_EMAIL: "glass@users.noreply.github.com",
          GIT_COMMITTER_NAME: "Glass",
          GIT_COMMITTER_EMAIL: "glass@users.noreply.github.com",
        };
        ...
        const message = `glass checkpoint ref=${input.checkpointRef}`;
