...
import { WorkingStateLive } from "./orchestration/Layers/WorkingState";
...
import { SkillCatalogLive } from "./skills/Layers/SkillCatalog";
...
const ServerSettingsLayerLive = ServerSettingsLive.pipe(Layer.provideMerge(PlatformServicesLive));
...
const ReactorLayerLive = Layer.empty.pipe(
  ...
  Layer.provideMerge(WorkingStateLive),
...
export const runServer = Layer.launch(
  makeServerLayer.pipe(Layer.provideMerge(ServerSettingsLayerLive)),
