 ...
 */
export class Open extends Context.Service<Open, OpenShape>()("glass/open") {}
...
export const launchDetached = Effect.fn("open/launchDetached")(function* (launch: EditorLaunch) {
...
}).pipe(Effect.withSpan("open/makeOpenLive"));
