...
import { CodexModelSelection } from "@glass/contracts";
...
import { normalizeCodexModelOptionsWithCapabilities } from "@glass/shared/model";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    return fileSystem
      .makeTempFileScoped({
        prefix: `glass-${prefix}-${process.pid}-${randomUUID()}.tmp`,
      })
      .pipe(
