...
import type { ChatAttachment, ModelSelection } from "@glass/contracts";

import type { TextGenerationError } from "../Errors.ts";

/** Reserved for model selection routing; no CLI backends are wired in this build. */
export type TextGenerationProvider = never;
...
export class TextGeneration extends ServiceMap.Service<TextGeneration, TextGenerationShape>()(
  "glass/git/Services/TextGeneration",
) {}
