    ...
    yield* Effect.gen(function* () {
      ...
      if (Option.isNone(existingProject)) {
        ...
        nextProjectDefaultModelSelection = existingProject.value.defaultModelSelection
          ? normalizeProjectDefaultModelSelection(existingProject.value.defaultModelSelection)
          : {
              provider: "codex",
              model: DEFAULT_MODEL_BY_PROVIDER.codex,
            };
...
function normalizeProjectDefaultModelSelection(selection: ModelSelection): ModelSelection {
  return {
    ...selection,
