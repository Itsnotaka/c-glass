...
import Migration0020 from "./Migrations/020_CanonicalizeLegacyProviderKinds.ts";
import Migration0021 from "./Migrations/021_ProjectionThreadMessageContent.ts";
...
export const migrationEntries = [
  ...
  [20, "CanonicalizeLegacyProviderKinds", Migration0020],
  [21, "ProjectionThreadMessageContent", Migration0021],
] as const;
